...
## MODIFIED
##` - now include os and time modules
import os
import time
...
def main():
    ...
    ## MODIFIED
    ##  - removed "download = true" after initially running on head-node to download data
    ##  - workers do not have internet access
    ...
    with open(out_filename, "a+") as out_file:
        out_file.write(str(elapsed_ns) + "," + str(start) + "," + str(end) + "," + nodename + "," + str(num_cpus) + "\n") 
